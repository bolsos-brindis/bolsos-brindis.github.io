            ...
            <div id="contenedorFooter" class="contenedor">
                <div class="footer-contenedor">
                    ...
                    <nav class="footer-bloque footer-social">
                        <ul>
                            <li>
                                <a href="https://www.instagram.com/itsbrindis" target="_blank">
                            ...
                            <li>
                                <a href="https://www.tiktok.com/@itsbrindis" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path
                            ...
                            <li>
                                <a href="https://pin.it/nJY41o2UN" target="_blank">
